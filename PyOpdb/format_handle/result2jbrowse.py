...
def res2jbrowse(_dir,srr_n,kegg_id):
    ...
    os.system(
        "cd " + path + " && for item in " + _dir[2] + "/*wig;do bin/wig-to-json.pl --wig $item --tracklabel ${item##*_};done")
    ...
    os.system("cp " + _dir[2] + "/rockhopper/*txt " + path + "/data/")
    os.system("cd " + path + " && bin/add-bw-track.pl --bw_url " + srr_n + "_forw_sort.bw --key forv.bw --label rnaseq1 --pos_color blue --plot")
    os.system(
