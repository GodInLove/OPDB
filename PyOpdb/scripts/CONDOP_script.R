...
res.com <- run.CONDOP(data.in, bkgExprCDS=0.2, bkgExprIGR=0.2,maxLenIGR=150, win.start.trp=c(100,10),win.end.trp=c(10,100), norm.type = "n1",cl.run = 30, nfolds = 5, cons = 2,find.ext=TRUE,return.all = FALSE,save.TAB.file = "CONDOP",verbose = TRUE)
